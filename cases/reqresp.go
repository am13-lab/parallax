	...
	return []runner.Spec{
		{
			...
			Run: func(ctx context.Context, te runner.TestEnv) []runner.Divergence {
				...
				return diverge("reqresp.status.valid", "reqresp", te.Meta, results, details)
			},
		},
		{
			...
			Run: func(ctx context.Context, te runner.TestEnv) []runner.Divergence {
				...
				return diverge("reqresp.ping.empty_body", "reqresp", te.Meta, results, details)
			},
		},
		{
			...
			Run: func(ctx context.Context, te runner.TestEnv) []runner.Divergence {
				...
				return diverge("reqresp.ping.extra_bytes", "reqresp", te.Meta, results, details)
			},
		},
		{
			...
			Run: func(ctx context.Context, te runner.TestEnv) []runner.Divergence {
				...
				return diverge("reqresp.status.malformed", "reqresp", te.Meta, results, details)
			},
		},
		{
			...
			Run: func(ctx context.Context, te runner.TestEnv) []runner.Divergence {
				...
				return diverge("reqresp.status.pre_status", "reqresp", te.Meta, results, details)
			},
		},
		{
			...
			Run: func(ctx context.Context, te runner.TestEnv) []runner.Divergence {
				...
				return diverge("reqresp.blocks_by_root.length_bomb", "reqresp", te.Meta, results, details)
			},
		},
		{
			...
			Run: func(ctx context.Context, te runner.TestEnv) []runner.Divergence {
				...
				return diverge("reqresp.blocks_by_root.trailing_bytes", "reqresp", te.Meta, results, details)
			},
		},
		{
			...
			Run: func(ctx context.Context, te runner.TestEnv) []runner.Divergence {
				...
				return diverge("reqresp.metadata.valid", "reqresp", te.Meta, results, details)
			},
		},
		{
			...
			Run: func(ctx context.Context, te runner.TestEnv) []runner.Divergence {
				...
				return diverge("reqresp.goodbye.valid", "reqresp", te.Meta, results, details)
			},
		},
		{
			...
			Run: func(ctx context.Context, te runner.TestEnv) []runner.Divergence {
				...
				return diverge("reqresp.unknown_protocol", "reqresp", te.Meta, results, details)
			},
		},
	}
}
